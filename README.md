...
>
> ### Какие пакеты здесь собраны
>
> Релиз [v25.12.5](https://github.com/koshelevnv/awg-openwrt/releases/tag/v25.12.5) содержит пакеты для **всех 93 платформ** OpenWrt 25.12.5 — 372 файла, по четыре на каждую пару target/subtarget. Сборка под другие версии OpenWrt здесь не проводилась: для них запустите Actions → «Create Release on Tag» → Run workflow, указав нужную версию (полная сборка занимает около полутора часов, под одну платформу — 10–15 минут).
>
> ### Установка
>
> ```
> sh <(wget -O - https://raw.githubusercontent.com/KeiRun/awg-openwrt/refs/heads/master/amneziawg-install.sh)
> ```
>
...
> - три туннеля одновременно: два на 2.0 и один на 3.1, конфликтов нет;
...
>
> Остальные 92 платформы собраны, но на оборудовании не тестировались.
>
> ### Авторство изменений
>
