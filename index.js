    ...
    const excludedBuilds = [
      ...
      },
      {
        target: 'octeon',
        subtarget: 'generic',
        reason: 'SDK build failure / unsupported platform (mips64_octeonplus)',
      },
      {
        target: 'bcm47xx',
        subtarget: 'mips74k',
        reason: 'SDK build failure / unsupported platform (mipsel_74kc)',
      },
      {
        target: 'lantiq',
        subtarget: 'xrx200_legacy',
        reason: 'SDK build failure / legacy platform (mips_24kc)',
      },
      {
        target: 'armsr',
        subtarget: 'armv7',
        reason: 'SDK build failure / unsupported platform (arm_cortex-a15_neon-vfpv4)',
      },
    ];
